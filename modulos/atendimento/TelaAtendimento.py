...
class TelaAtendimeno:
    ...
    def detalhes_atendimento(self, pedidos: list = []):
        ...
        layout = [
            ...
            [sg.Column(lista_de_pedidos,  key='pedidos') if len(lista_de_pedidos) > 0 else sg.Text("Não há pedidos cadastrados")],
        ...
        while True:
            ...
            if event == 'Adicionar pedido':
                self.fechar_tela()
                self.mostra_mensagem("TODO: Implementar cadastro de pedido")
